...
package fl.aapttest.com.apkUtil.utils;

import fl.aapttest.com.apkUtil.entity.ApkInfo;
import fl.aapttest.com.apkUtil.entity.ImpliedFeature;
...
//			System.out.println(source);
	...
	public static void main(String[] args) {
		try {
			String demo = "/Users/feilong/Downloads/yingmitiantang.apk";

			if (args.length > 0) {
				if(args[0].equals("-version") || args[0].equals("-v")){
					System.out.println("ApkUtil   -by feilong");
					return;
				}
				demo = args[0];
			}
